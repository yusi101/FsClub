...
<audio controls autoplay class="audio">
	<source src="${pageContext.request.contextPath}/static/media/Music.mp3" type="audio/mp3">
	<source src="${pageContext.request.contextPath}/static/media/Music.ogg" type="audio/ogg">
	<source src="${pageContext.request.contextPath}/static/media/Music.aac" type="audio/mp4">
</audio>
<!--音乐 END-->
...
<div style="text-align:center;z-index:999;font-size: 88px;position:fixed;bottom:280px;height: 150px;width: 360px">
	<font style="font-size: 40pt; filter: shadow(color=#9370db); width: 100%; color: #ffebcd; line-height: 150%; font-family: 隶书">
			<b onclick="tologin()">
				<%--<a href="${ctp}/main/index"> GAME START</a>--%>
					GAME START
			</b>
	<br/>
		<b>
