...
<body>
	<table class="table table-striped table-bordered table-hover">
		<tr>
			<td width="40%"><span style="color: red">*</span>账号：</td>
		...
		<tr>
			<td>性别：</td>
			<td>
				<input type="radio" name="SEX" value="1" runat="server" checked=＂checked/>&nbsp;男&nbsp;&nbsp;&nbsp;
				<input type="radio" name="SEX"  value="0" runat="server"/>&nbsp;女
			</td>
		</tr>
		<tr>
			<td>邮件：</td>
